 ...
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |Shft/[|Rais/Z|Lowr/X|   C  |   V  |   B  | |   N  |   M  |   ,  |Rais/.|Lowr//|Shft/]|
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * |Adjust|Lower | Alt  | GUI  |Space | Bksp | |  Esc | Enter|   (  |   )  |Raise |Numpad|
 * `-----------------------------------------' `-----------------------------------------'
 */
[_QWERTY] = KEYMAP( \
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS, \
  KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
  SFT_T(KC_LBRC), LT(_RAISE, KC_Z), LT(_LOWER, KC_X), KC_C, KC_V, KC_B, \
  KC_N, KC_M, KC_COMM, LT(_RAISE, KC_DOT), LT(_LOWER, KC_SLSH), SFT_T(KC_RBRC), \
  ADJUST, LOWER, KC_LALT, KC_LGUI, KC_SPC, KC_BSPC, \
  KC_ESC, KC_ENT, KC_LPRN, KC_RPRN, RAISE, NUMPAD \
),
...
[_RAISE] = KEYMAP( \
  ...
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_DEL, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
),
